...
public class LogIn extends javax.swing.JFrame {
    ...
    void writeName(String s) throws IOException{
        BufferedWriter writeval = new BufferedWriter(new FileWriter("nurName.txt"));//"C:\\Users\\User 2\\Desktop\\clinicdata.txt"));
            writeval.write(s);
            writeval.close();
    ...
    private void sigbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sigbtnActionPerformed
        try
        {
            ...
            String sql = "SELECT * FROM nurse WHERE nurseID= ? AND PASSWORD = ?";
            ...
            if (rs.next()){
              ...
              new LogIn().writeName(rs.getString("lastname"));
