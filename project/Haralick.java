...
//        }
        ByteProcessor pi = new ByteProcessor( ip.getWidth(), ip.getHeight() );
    ...
    public String haralickFeature(String file){
        ImagePlus aux = new ImagePlus(file);//"C:\\Users\\User 2\\Desktop\\myframe6.png");
        ImageProcessor ip=aux.getProcessor();
       // ByteProcessor ipp = new ByteProcessor( ip.getWidth(), ip.getHeight() );
	//ha.process(ipp);
       
        run(ip);
        String s = str[0]+","+str[1]+","+str[2]+","+str[3]+","+str[4]+","+str[5]+","+str[6]+","+str[7]+","+str[8]+","+str[9]+","+str[10]+","+str[11]+","+
                str[12]+","+str[13];
...
//        Haralick ha = new Haralick();
//        ImagePlus aux = new ImagePlus("C:\\Users\\User 2\\Desktop\\myframe6.png");
//        ImageProcessor ip=aux.getProcessor();
//       // ByteProcessor ipp = new ByteProcessor( ip.getWidth(), ip.getHeight() );
//	//ha.process(ipp);
//       
